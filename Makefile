...
ifeq ($(machine),zoidberg)
  CC = g++
  LDFLAGS = -lHYPRE -lmpi -lhdf5 -lhdf5_hl_cpp -lhdf5_cpp -lhdf5_hl -lhdf5 
  CXXFLAGS = -Ilib -I$(HDF5INCLUDE) -I$(MPI_INCLUDE) -I$(HYPREINCLUDE) -std=c++11 -lz -ldl -lm -O3 -march=native -Wall -D VERBOSE 
else
  # CC = mpic++
