...
ifeq ($(machine),zoidberg)
  CC = g++
  LDFLAGS = -lHYPRE -lmpi -lmpi_cxx -lhdf5 -lhdf5_hl_cpp  -lhdf5_hl -lhdf5
  CXXFLAGS = -Ilib -I$(MPI_INCLUDE) -I$(HDF5INCLUDE) -I$(HYPREINCLUDE) -std=c++11 -lz -ldl -lm -pthread -Wl,-rpath -Wl,--enable-new-dtags -O3 -march=native -Wall -D VERBOSE 
else
  # CC = mpic++
