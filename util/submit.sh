...
#SBATCH --comment="Testing plume execution"          # An arbitrary comment on the job
...
#SBATCH --workdir="/data/habl"   # Set current directory before job starts - LOGIN is your login
