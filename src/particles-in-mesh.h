...
struct pic_operations{
    ...
    static void energy_field(fmatrix & p, int & n_active, fmatrix & kefield, mesh_set & mesh, imatrix & lpos);
    static void flux_field(fmatrix & p, int & n_active, fmatrix & ffield_x, fmatrix & ffield_y, mesh_set & mesh,imatrix & lpos);
